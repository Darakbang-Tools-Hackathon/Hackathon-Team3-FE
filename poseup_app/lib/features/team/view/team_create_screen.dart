...
class _TeamCreateScreenState extends ConsumerState<TeamCreateScreen> {
  ...
  Future<void> _handleCreateTeam() async {
    ...
    try {
      await ref.read(teamServiceProvider).createTeam(_controller.text.trim());
      // 성공: 기존 바텀시트 유지
      if (mounted) {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _loading ? null : _handleCreateTeam,
                  ...
                  child: _loading
                      ...
                      : const Text('팀 만들기', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
